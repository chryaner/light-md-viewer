...
- New icon: a heading and lines of body text, which is what the app puts on screen. It replaces
  the M and arrow, and needs no letterform to read at 16 px.
...
[0.1.2]: https://github.com/chryaner/light-md-viewer/compare/v0.1.1...v0.1.2
